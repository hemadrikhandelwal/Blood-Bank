		...
		<div class="col-sm-2">
			<div class="menu">
				<ul>
					...
					<li class="selected"><a href="donation.php"><i class="fa fa-id-card"></i>Donation list</a></li>
				</ul>	
			</div>
		</div>	
	<div class="col-sm-2">
				...
				<tbody>
					<?php
							...
							while($row=mysqli_fetch_array($run))
							{
								...
								$blood_bank_address=$row['blood_bank_address'];
								$contact_detail=$row['contact_detail'];
								echo"<tr><td>$sno</td><td>$don_name</td><td>$don_address</td><td>$blood_bank_name</td><td>$blood_bank_address</td><td>$blood_amt</td><td>$contact_detail</td><td><a href='edit_don.php?edi=$row[don_id]'><span class='fa fa-pencil-square-o' aria-hidden='true'></span>EDIT</a></td><td><a href='delete.php?del=$row[don_id]'><span class='fa fa-trash' aria-hidden='true'></span>Delate</a></td></tr>";
								$sno+=1;
...
<div class="container">
	<button type="button"><span><a href="insert_info.php">ADD INFO</a> </span></button>
</div>
